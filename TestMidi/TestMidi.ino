...
Mux M1(A0, 15, true); //Digital multiplexer on Arduino analog pin A0
//*******************************************************************
...
Button MBU1(M1, 10, 1, 82, 1, 5);
Button MBU2(M1, 11, 1, 71, 1, 5);
Button MBU3(M1, 12, 1, 72, 1, 5);
Button MBU4(M1, 13, 1, 73, 1, 5);
Button MBU5(M1, 14, 1, 74, 1, 5);
...
Pot MPO1(M1, 0, 0, 70, 1);
Pot MPO2(M1, 1, 0, 71, 1);
Pot MPO3(M1, 2, 0, 72, 1);
Pot MPO4(M1, 3, 0, 73, 1);
Pot MPO5(M1, 4, 0, 74, 1);
Pot MPO6(M1, 5, 0, 75, 1);
Pot MPO7(M1, 6, 0, 76, 1);
Pot MPO8(M1, 7, 0, 77, 1);
Pot MPO9(M1, 8, 0, 78, 1);
Pot MPO10(M1, 9, 0, 79, 1);
//Pot MPO11(M1, 10, 0, 80, 1);
//Pot MPO12(M1, 11, 0, 81, 1);
...
Pot *MUXPOTS[] {&MPO1, &MPO2, &MPO3, &MPO4, &MPO5, &MPO6, &MPO7, &MPO8, &MPO9, &MPO10};
//*******************************************************************
